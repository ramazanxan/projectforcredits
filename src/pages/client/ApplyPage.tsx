    ...
    <AppShell role="client">
      ...
      <div className="grid gap-6 xl:grid-cols-[1.05fr_0.95fr]">
        <GlassCard className="space-y-6">
          ...
          <Button onClick={() => setSubmitted(true)}>{t('client.apply.submit')}</Button>
        </GlassCard>
        ...
        <GlassCard className="space-y-5">
          ...
          <div className="space-y-4">
            ...
            {submitted ? (
              <div className="rounded-[22px] border border-[rgba(57,255,20,0.18)] bg-[rgba(57,255,20,0.08)] p-5 text-[var(--text-primary)]">
                Заявка сохранена как черновик. После подключения backend она будет отправляться по API.
              </div>
            ) : null}
          </div>
        </GlassCard>
